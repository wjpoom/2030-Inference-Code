...
MODEL_NAME=SliMM-DeepStackM-Qwen2-0.5B/stage1
...
bash scripts/slimm/job_template.sh $MODEL_NAME $DATA_PATH  \
    ...
    --use_deepstack --deepstack_type midlayers


PREV_CKPT=$CKPT
DATA_PATH=scripts/data/llava_ov_mid.yaml
MODEL_NAME=SliMM-DeepStackM-Qwen2-0.5B/stage1.5
CKPT=checkpoints/$MODEL_NAME
...
MODEL_NAME=SliMM-DeepStackM-Qwen2-0.5B/
CKPT=checkpoints/$MODEL_NAME
